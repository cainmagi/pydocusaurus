...
Overall, the top-level class docstring will be interpretedd as a multi-line Markdown document describing the class. The other rules are:
...
Note that the `DocDataClass` and [`DocClass`](../../apis/core/classes/DocClass.mdx) are subclasses of the same prototype class. Therefore, the other fields such as `methods` and `properties` work in the same way when extracting the docstring information.
...
|  Field  |     Type     | <center>Description</center>                                           |
| :-----: | :----------: | :--------------------------------------------------------------------- |
